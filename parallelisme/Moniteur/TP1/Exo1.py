...
if __name__ == '__main__':
    if len(sys.argv) != 6:
        print("Usage: %s <Nb Prod <= 20> <Nb times Prod <= 20> <Nb Conso <= 20> <Nb times conso <= 20> <Nb Cases <= 20>" % sys.argv[0])
        sys.exit(1)

    nb_prod = int(sys.argv[1])
    nb_cons = int(sys.argv[3])
    nb_cases = int(sys.argv[5])

    nb_times_prod = int(sys.argv[2])
    nb_times_cons = int(sys.argv[4])
